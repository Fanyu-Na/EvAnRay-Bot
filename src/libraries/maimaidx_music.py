...
for item in obj:
    if item['basic_info']['from'] == "maimai でらっくす":
        item['basic_info']['from'] = "舞萌DX"
    if item['basic_info']['from'] == "maimai でらっくす Splash":
        item['basic_info']['from'] = "舞萌DX 2021"
    if item['basic_info']['from'] == "maimai でらっくす UNiVERSE":
        item['basic_info']['from'] = "舞萌DX 2022"
    if item['basic_info']['from'] == "maimai でらっくす FESTiVAL":
        item['basic_info']['from'] = "舞萌DX 2023"

change_user_data = obj
